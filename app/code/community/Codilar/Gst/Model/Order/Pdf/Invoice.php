...
class Codilar_Gst_Model_Order_Pdf_Invoice extends Mage_Sales_Model_Order_Pdf_Invoice
{
    /**
    ...
    {
        $CreatedAt = $this->order_detail->getCreatedAt();
        ...
        $lines[0][] = array(
            'text'  => Mage::helper('sales')->__('CGST'),
            'feed'  => 410,
            'align' => 'right'
        );

        $lines[0][] = array(
            'text'  => Mage::helper('sales')->__('SGST'),
            'feed'  => 460,
            'align' => 'right'
        );

        $lines[0][] = array(
            'text'  => Mage::helper('sales')->__('IGST'),
            'feed'  => 510,
            'align' => 'right'
        );
        }
    ...
    public function getPdf($invoices = array())
    {
        ...
        foreach ($invoices as $invoice) {
            ...
            $this->order_detail = $invoice->getOrder();
            /* Add image */
    ...
    protected function insertOrder(&$page, $obj, $putOrderId = true)
    {
        ...
        $gst_status = Mage::getStoreConfig('general/gst_options/gst_id');
        ...
        $page->drawText(
            Mage::helper('sales')->__('GSTIN : ') . $gst_status, 35, ($top -= 15), 'UTF-8'
        );
