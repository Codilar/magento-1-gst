...
class Codilar_Gst_Model_Resource_Report_Order_Createdat extends Mage_Sales_Model_Resource_Report_Order_Createdat
{
    ...
    protected function _aggregateByField($aggregationField, $from, $to)
    {
        ...
        try {
            ...
            $columns = array(
                ...
                'total_cgst'            => new Zend_Db_Expr('SUM(ot.cgst)'),
                'total_sgst'            => new Zend_Db_Expr('SUM(ot.sgst)'),
                'total_igst'            => new Zend_Db_Expr('SUM(ot.igst)'),
            );
            ...
            $select->from(array('o' => $this->getTable('sales/order')), $columns)
                ...
                ->join(array('ot' => $this->getTable('tax/sales_order_tax')), 'ot.order_id = o.entity_id', array())
